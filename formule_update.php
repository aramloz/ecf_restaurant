...
if (isset($_GET['id']) && isset($_POST['submit'])) {
    ...
    // Update the formule in the quai_antique_formule table
    $sql = "UPDATE quai_antique_formule SET formule_titre = '$titre', formule_description = '$description', formule_prix = '$prix' WHERE formule_id = '$id'";
